    ...
    def call
...

      {
        ...
        "assumptions" => [
          ...
          "Вноската се закръгля до евроцент; последната се коригира, за да занули главницата.",
          "Не са моделирани гратисен период, балонна вноска, предсрочно погасяване или дневна банкова конвенция."
        ]
      }
    end
